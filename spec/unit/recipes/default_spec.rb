...
describe 'memcached::default' do
  let(:chef_run) { ChefSpec::ChefRunner.new(cookbook_path: '..').converge(described_recipe) }
  ...
  context 'on rhel' do
    let(:chef_run) { ChefSpec::ChefRunner.new(cookbook_path: '..', platform: 'redhat', version: '6.3').converge(described_recipe) }
  ...
  context 'on smartos' do
    let(:chef_run) { ChefSpec::ChefRunner.new(cookbook_path: '..', platform: 'smartos', version: 'joyent_20130111T180733Z').converge(described_recipe) }
  ...
  context 'on ubuntu' do
    let(:chef_run) { ChefSpec::ChefRunner.new(cookbook_path: '..', platform: 'ubuntu', version: '12.04').converge(described_recipe) }
